import {CommonGroupProperties, ExtensionGroupProperties, DocumentGroupProperties, getElementTypeListenerProperties} from '../common';
  ...
  properties: {
    ...
    'sequenceFlow.type': {
      ...
      setValue(businessObject: ModdleElement, key: string, value: string): void {
        ...
        const sourceShape = bpmnContext.getModeler().get('elementRegistry').get(line.businessObject.sourceRef.id);
